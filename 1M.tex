...
\mylinkb{1M} & \mylinkt & \mylink{1Mcomp} \\
...
\mylink{1h2n} & {2NT} & 4+\H s, slam interest \\
...
& 2\D/2\H &5+\D/\H\ GF \\
& 2\S & 7-10HCP, 3+\S \\
\mylink{1s2n} & {2NT} &4+\S s, slam interest \\
...
\begin{longtable}{C{\linklength} C{\bidlength} l}
\mylinkb{1h} & \mylinkt \\
& 3\C & any MIN [R] \mylink{1h2n3c3d} 3\D=ask \\
& 3\D & MAX, no shortness [R] 3\H=ask [O] same as 3\C-3\D \\
& 3\H & MAX, 0-1\C \\
& 3\S & MAX, 0-1\D \\
& 3NT & MAX, 0-1\S \\ 
...
\begin{longtable}{C{\linklength} C{\bidlength} l}
\mylinkb{1s} & \mylinkt \\
& 3\C & any MIN [R] \mylink{1s2n3c3d} 3\D=ask \\
& 3\D & MAX, no shortness [R] 3\H=ask [O] same as 3\C-3\D \\
& 3\H & MAX, 0-1\C \\
& 3\S & MAX, 0-1\D \\
& 3NT & MAX, 0-1\S \\ 
